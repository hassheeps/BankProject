...
namespace BankOfBIT_BC.Controllers
{
    public class ChequingAccountsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BankAccountId,ClientId,AccountStateId,AccountNumber,Balance,DateCreated,Notes,ChequingServiceCharge")] ChequingAccount chequingAccount)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BankAccountId,ClientId,AccountStateId,AccountNumber,Balance,DateCreated,Notes,ChequingServiceCharge")] ChequingAccount chequingAccount)
        {
            if (ModelState.IsValid)
            {
